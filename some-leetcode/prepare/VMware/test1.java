...
public class SensorNetwork {
	...
	public static void main(String[] args) {
		...
		/* before --- */ int i12 = 0; /* middle --- */ int j12 = 0; // end ---
		String test12 = "// hey there"; // test12
		String test13 = "/* hey there"; // test13
		String test14 = "// hey there"; // test14
		char test15 = 'test//hi"//not end*/ /*'; // test15
	}
}